// Events feature temporarily hidden site-wide — this preview iframe target
// is only ever loaded by admin/(protected)/events' EventForm, which is
// itself disabled. Kept as an inert stub rather than deleted.
